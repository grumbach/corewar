...
#    Updated: 2017/05/10 22:47:52 by agrumbac         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#
# ############################## RULE ############################################
# all: $(VM_NAME) #ride dragon unicorn $(ASM_NAME)
#
# $(VM_NAME): $(VM_OBJ_FILE) #lib
# 	@$(CC) $(VM_OBJ_FILE) -I$(INC_PATH) $(LIB_FLAG) -o $@ ${LDFLAGS}
#
# $(ASM_NAME): $(ASM_OBJ_FILE) #lib
# 	@$(CC) $(ASM_OBJ_FILE) -I$(INC_PATH) $(LIB_FLAG) -o $@ ${LDFLAGS}
#
# $(VM_OBJ_PATH)/%.o: $(VM_SRC_PATH)/%.c
# 	@mkdir -p $(VM_OBJ_PATH)
# 	@mkdir -p $(VM_OBJ_PATH)/redcodes
# 	@mkdir -p $(VM_OBJ_PATH)/bonus
# 	@mkdir -p $(VM_OBJ_PATH)/mars
